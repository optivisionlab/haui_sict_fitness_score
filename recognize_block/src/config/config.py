...
API_HANDLER_USER_COOLDOWN_MS = int(env("API_HANDLER_USER_COOLDOWN_MS", 1000))
...
DROP_OLDEST_FRAME = as_bool(env("DROP_OLDEST_FRAME", True))
...
TRACK_RETRY_INTERVAL_SEC = float(env("TRACK_RETRY_INTERVAL_SEC", 1.0))
TRACK_MAX_RETRY = int(env("TRACK_MAX_RETRY", 3))
TRACK_RETRY_GROWTH_FACTOR = float(env("TRACK_RETRY_GROWTH_FACTOR", 1.25))
MIN_SEARCH_BOX_AREA = int(env("MIN_SEARCH_BOX_AREA", 12000))